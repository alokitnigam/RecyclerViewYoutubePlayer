package com.example.recyclerviewyoutubeplayer.youtubeView
...
import com.example.recyclerviewyoutubeplayer.youtubeView.fragment.YouTubeBaseFragment
import com.example.recyclerviewyoutubeplayer.youtubeView.fragment.YouTubeFragment
import com.example.recyclerviewyoutubeplayer.youtubeView.fragment.YouTubeWebViewFragment
import com.example.recyclerviewyoutubeplayer.youtubeView.listener.YouTubeEventListener
import com.example.recyclerviewyoutubeplayer.youtubeView.models.ImageLoader
...
import com.example.recyclerviewyoutubeplayer.youtubeView.util.ServiceUtil
...
class YouTubePlayerView : FrameLayout {
    ...
    fun initPlayer(
        apiKey: String,
        videoId: String,
        webViewUrl: String?, @YouTubePlayerType playerType: Int,
    ...
    private fun init(context: Context) {
        ...
        if (progressBar != null && Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                color = context.resources.getColor(R.color.pure_white, null)
            } else {
                color = context.resources.getColor(R.color.pure_white)
            }
    ...
    private fun attachPlayer(isNative: Boolean) {
        if (playerContainer!!.id != R.id.youtubeFragmentContainer) {
            ...
            if (isNative) {
                youtubePlayerFragment = YouTubeFragment.newInstance(key!!, videoId!!, time)
